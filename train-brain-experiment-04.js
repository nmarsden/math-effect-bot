...
function train_brain() {
    ...
    var trackedLearningTimes = [];

    var num_inputs;

    for (num_inputs = 2; num_inputs <= MAX_NUM_INPUTS; num_inputs = num_inputs*2) {
        ...
        console.log("-----------------------------------------------------------------------");
        console.log("*** Started Learning with " + num_inputs + " inputs: upto max. iterations " + NUM_TURNS + " ***");
        console.log("-----------------------------------------------------------------------");
        ...
        console.log("-------------------------------------------------------------------------------------");
        console.log("*** Average reward every " + AVERAGE_WINDOW_SIZE + ": Number of iterations reached " + NUM_TURNS + " ***");
        console.log("-------------------------------------------------------------------------------------");
        ...
        trackedLearningTimes.push(learningTime[0].duration);
    ...
    console.log("-------------------------------------------------------------------------------------");
    console.log("Number of inputs vs Learning Time (for 4000 iterations)");
    console.log("-------------------------------------------------------------------------------------");
    var trackedLearningTimesOutput = "num_inputs, learning_time\n";
    for (turn = 0; turn < trackedLearningTimes.length; turn++) {
        trackedLearningTimesOutput += (turn + 1) + "," + trackedLearningTimes[turn] + "\n";
    }
    console.log(trackedLearningTimesOutput);
